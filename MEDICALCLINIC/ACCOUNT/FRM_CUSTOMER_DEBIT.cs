...
{
    public partial class FRM_CUSTOMER_DEBIT :MEDICALCLINIC. SETTING.baseclinicanddental
    {
        DataTable dt = new DataTable();
        
        public FRM_CUSTOMER_DEBIT()
        {
            InitializeComponent();
        }
       ...
       //     lr.Print();
        ...
        private void BTN_SEARCH_Click(object sender, EventArgs e)
        {
            try
            {
                this.gET_DEBIT_BY_BCODE_ACOD_DETTableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_DEBIT_BY_BCODE_ACOD_DET, new System.Nullable<int>(((int)(System.Convert.ChangeType(0, typeof(int))))), new System.Nullable<int>(((int)(System.Convert.ChangeType(19, typeof(int))))), new System.Nullable<int>(((int)(System.Convert.ChangeType(pERSON_NAMEComboBox.SelectedValue, typeof(int))))),0,dateTimePicker1.Value,dateTimePicker2.Value ,new System.Nullable<int>(((int)(System.Convert.ChangeType(1, typeof(int))))));
