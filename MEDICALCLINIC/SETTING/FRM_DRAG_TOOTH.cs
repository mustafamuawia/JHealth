...
{
    public partial class FRM_DRAG_TOOTH : baseclinicanddental
    {

        public FRM_DRAG_TOOTH()
        {
            InitializeComponent();
        }
        ...
        private void BTN_SEARCH_Click(object sender, EventArgs e)
        {
            ...
            SEARCH.FRM_SEARCH_TOOHT_DRAG FRM = new SEARCH.FRM_SEARCH_TOOHT_DRAG();
            FRM.ShowDialog();
        }
 ...
 if (MSG.Msg.MsgBoxResult(CLS.Q_MSG_SAVE))
                {
                    ...
                    INSERTED.P_INSERT_TOOTH_DRAGE(
                      CLS.CHEECK_CODE
                    , ref  CLS.CLIENT_CODE
                    , DRAGE_NAME_ARTextBoxX.Text
                    , dOCTOR_NAMEComboBox.SelectedValue.ToInt()
...
if (MSG.Msg.MsgBoxResult(CLS.Q_MSG_UPDATE))
                {
                    ...
                    INSERTED.P_UPDATE_T_DRAGE_TOOTH(
        ...
        private void BTN_DELETE_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MSG.Msg.MsgBoxResult(CLS.Q_MSG_DELETE))
                {
                    ...
                    INSERTED.P_DELETE_TOOTH_DRAGE(Convert.ToInt32(DRAGE_CODETextBoxX.Text), ref  CLS.SUBMIT_FLAG);
