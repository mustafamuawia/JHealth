...
{
    public partial class FRM_MAJOR : BASEANYFORM
    {
        ...
        {
            SEARCH.FRM_SEARCH_MAJOR FRM = new SEARCH.FRM_SEARCH_MAJOR();
            FRM.ShowDialog();
        }
        ...
        private void BTN_SAVE_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MSG.Msg.MsgBoxResult(CLS.Q_MSG_SAVE))
                {
                    ...
                    INSERTED.P_INSERT_T_MAJOR(CLS.CHEECK_CODE, ref  CLS.CLIENT_CODE, MAJOR_NAME_ARTextBoxX.Text, true, ref  CLS.SUBMIT_FLAG);
...
if (MSG.Msg.MsgBoxResult(CLS.Q_MSG_UPDATE))
                {
                    ...
                    INSERTED.P_UPDATE_T_MAJOR(Convert.ToInt32(MAJOR_CODETextBoxX.Text), MAJOR_NAME_ARTextBoxX.Text, true, ref  CLS.SUBMIT_FLAG);
        ...
        private void BTN_DELETE_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MSG.Msg.MsgBoxResult(CLS.Q_MSG_DELETE))
                {
                    ...
                    INSERTED.P_DELETE_T_MAJOR(Convert.ToInt32(MAJOR_CODETextBoxX.Text), ref  CLS.SUBMIT_FLAG);
