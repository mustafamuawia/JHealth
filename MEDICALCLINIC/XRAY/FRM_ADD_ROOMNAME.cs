...
{
    public partial class FRM_ADD_ROOMNAME : MEDICALCLINIC.XRAY.basexray
    {

        public FRM_ADD_ROOMNAME()
        {
            InitializeComponent();
        ...
        {
            this.gET_RAYROOM_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_RAYROOM_NAME_CODE, "");
        }
        byte[] imge1;
 ...
 if (MSG.Msg.MsgBoxResult(CLS.Q_MSG_SAVE))
        ...
        private void TXT_SEARCH_TextChanged(object sender, EventArgs e)
        {
            try
            {
                this.gET_RAYROOM_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_RAYROOM_NAME_CODE, TXT_SEARCH.Text);
            }
