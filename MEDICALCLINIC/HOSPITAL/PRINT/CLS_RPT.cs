        ...
        public static void Print(this LocalReport report, PageSettings pageSettings)
        {
            ...
            else
            {
                ...
                if (Properties.Settings.Default.PRINTER_NAME==String.Empty)
                    throw new Exception("Error: no Choose any print.");
                printDocument.PrinterSettings.PrinterName = Properties.Settings.Default.PRINTER_NAME;
                printDocument.Print();
            }
