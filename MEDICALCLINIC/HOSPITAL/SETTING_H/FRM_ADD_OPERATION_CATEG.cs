...
{
    public partial class FRM_ADD_OPERATION_CATEG :MEDICALCLINIC. SETTING.BASEANYFORM
    {

        public FRM_ADD_OPERATION_CATEG()
        {
            InitializeComponent();
        ...
        private void FRM_ADD_OPERATN_INFO_Load(object sender, EventArgs e)
        {
            try
            {
                this.gET_H_CATEG_OPERATION_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_H_CATEG_OPERATION_NAME_CODE,  "");
            }
            catch  
            {
 ...
 if (MSG.Msg.MsgBoxResult(CLS.Q_MSG_SAVE))
                {
                 ...
                 int   CATEGId = int.Parse(INSERTEDC.P_INSERT_T_H_OPERATION_CATEG(
        ...
        private void TXT_SEARCH_TextChanged(object sender, EventArgs e)
        {
            try
            {
                this.gET_H_CATEG_OPERATION_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_H_CATEG_OPERATION_NAME_CODE, TXT_SEARCH.Text);
            }
 ...
 if (MSG.Msg.MsgBoxResult(CLS.Q_MSG_UPDATE))
                {
                    ...
                    INSERTED.P_H_UPDATE_OPERATION_CATEG(
