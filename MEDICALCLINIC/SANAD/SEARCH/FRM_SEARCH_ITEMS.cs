...
namespace MEDICALCLINIC.SEARCH
{
    public partial class FRM_SEARCH_ITEMS : Form
    {
        ...
        private void FRM_SEARCH_SANAD_Load(object sender, EventArgs e)
        {
            try
            {
                this.gET_ITEM_NAME_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_ITEM_NAME_NAME_CODE, "");
            }
        ...
        private void TXT_SEARCH_TextChanged(object sender, EventArgs e)
        {
            try
            {
                this.gET_ITEM_NAME_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_ITEM_NAME_NAME_CODE,TXT_SEARCH.Text);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void dataGridView2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ((SETTING .FRM_ITEM)Application.OpenForms["FRM_ITEM"]).ITEM_CODETextBoxX .Text =
                dataGridView2.CurrentRow.Cells[0].Value.ToString();
            ((SETTING.FRM_ITEM)Application.OpenForms["FRM_ITEM"]).ITEM_NAME_ARTextBoxX.Text =
               dataGridView2.CurrentRow.Cells[2].Value.ToString();
            ((SETTING.FRM_ITEM)Application.OpenForms["FRM_ITEM"]).BARCODETextBoxX.Text =
             dataGridView2.CurrentRow.Cells[1].Value.ToString();
            ((SETTING.FRM_ITEM)Application.OpenForms["FRM_ITEM"]).GROUPComboBox.SelectedValue =
