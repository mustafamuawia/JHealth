...
{
    public partial class FRM_SEARCH_DESC : Form
    {

        public FRM_SEARCH_DESC()
        {
            InitializeComponent();
        ...
        private void TXT_SEARCH_TextChanged(object sender, EventArgs e)
        {
            try
            {
                this.gET_DESCRPTION_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_DESCRPTION_NAME_CODE, TXT_SEARCH.Text);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void dataGridView2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ((SETTING.FRM_DESC)Application.OpenForms["FRM_DESC"]).DESC_CODETextBoxX .Text =
                dataGridView2.CurrentRow.Cells[0].Value.ToString();
            ((SETTING.FRM_DESC)Application.OpenForms["FRM_DESC"]).DESC_NAME_ARTextBoxX.Text =
               dataGridView2.CurrentRow.Cells[1].Value.ToString();
            ((SETTING .FRM_DESC)Application.OpenForms["FRM_DESC"]).DOCTOR_COMB.SelectedValue =
        ...
        private void fillToolStripButton_Click_1(object sender, EventArgs e)
        {
            try
            {
               // this.gET_DESCRPTION_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_DESCRPTION_NAME_CODE, iD_DESCToolStripTextBox.Text);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
