...
{
    public partial class FRM_SERCH_GROUP_DRAGE : Form
    {

        public FRM_SERCH_GROUP_DRAGE()
        {
            InitializeComponent();
        ...
        private void dataGridView2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ((SETTING.FRM_DRAGE_GROUP)Application.OpenForms["FRM_DRAGE_GROUP"]).MAJOR_CODETextBoxX.Text =
                dataGridView2.CurrentRow.Cells[0].Value.ToString();
            ((SETTING.FRM_DRAGE_GROUP)Application.OpenForms["FRM_DRAGE_GROUP"]).MAJOR_NAME_ARTextBoxX.Text =
