...
{
    public partial class FRM_SEARCH_STATE : Form
    {

        public FRM_SEARCH_STATE()
        {
            InitializeComponent();
        ...
        private void FRM_SEARCH_SANAD_Load(object sender, EventArgs e)
        {
            try
            {
                this.gET_STATE_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_STATE_NAME_CODE, "");
            }
        ...
        private void TXT_SEARCH_TextChanged(object sender, EventArgs e)
        {
            try
            {
                this.gET_STATE_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_STATE_NAME_CODE, TXT_SEARCH.Text);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void dataGridView2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ((SETTING .FRM_STATE)Application.OpenForms["FRM_STATE"]).STATE_CODETextBoxX.Text =
                dataGridView2.CurrentRow.Cells[0].Value.ToString();
            ((SETTING.FRM_STATE)Application.OpenForms["FRM_STATE"]).STATE_NAME_ARTextBoxX.Text =
               dataGridView2.CurrentRow.Cells[1].Value.ToString();
            ((SETTING.FRM_STATE)Application.OpenForms["FRM_STATE"]).DOCTOR_COMB.SelectedValue =
