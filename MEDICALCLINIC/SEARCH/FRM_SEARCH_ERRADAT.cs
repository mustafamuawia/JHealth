...
{
    public partial class FRM_SEARCH_ERRADAT : Form
    {

        public FRM_SEARCH_ERRADAT()
        {
            InitializeComponent();
        ...
        private void FRM_SEARCH_SANAD_Load(object sender, EventArgs e)
        {
            try
            {
                this.p_GET_ERRADAT_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.P_GET_ERRADAT_NAME_CODE, "");
            }
        ...
        private void TXT_SEARCH_TextChanged(object sender, EventArgs e)
        {
            try
            {
                this.p_GET_ERRADAT_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.P_GET_ERRADAT_NAME_CODE, TXT_SEARCH .Text );
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void dataGridView2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ((SETTING .FRM_INCOMING)Application.OpenForms["FRM_INCOMING"]).INCOMING_CODETextBoxX.Text =
                dataGridView2.CurrentRow.Cells[0].Value.ToString();
            ((SETTING .FRM_INCOMING)Application.OpenForms["FRM_INCOMING"]).INCOMING_NAMMETextBoxX .Text =
