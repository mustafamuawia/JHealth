...
namespace MEDICALCLINIC.SEARCH
{
    public partial class FRM_SEARCH_BOOKING_T : Form
    {
        ...
        private void FRM_SEARCH_SANAD_Load(object sender, EventArgs e)
        {
            try
            {
                this.gET_BOOKI_T_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_BOOKI_T_NAME_CODE, "");
            }
        ...
        private void TXT_SEARCH_TextChanged(object sender, EventArgs e)
        {
            try
            {
                this.gET_BOOKI_T_NAME_CODETableAdapter.Fill(this.mEDICAL_CLINIC_DBDataSet.GET_BOOKI_T_NAME_CODE, TXT_SEARCH .Text );
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
